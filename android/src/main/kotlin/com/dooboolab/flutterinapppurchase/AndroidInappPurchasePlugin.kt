        ...
        try {
            ...
            when (prorationMode) {
                ...
                ProrationMode.IMMEDIATE_AND_CHARGE_PRORATED_PRICE -> {
                    params.setSubscriptionReplacementMode(SubscriptionReplacementMode.CHARGE_PRORATED_PRICE)
                    if (type != BillingClient.ProductType.SUBS) {
                        safeChannel.error(
                            TAG,
                            "buyItemByType",
                ...
                ProrationMode.IMMEDIATE_WITHOUT_PRORATION -> params.setSubscriptionReplacementMode(SubscriptionReplacementMode.WITHOUT_PRORATION)
                ProrationMode.DEFERRED -> params.setSubscriptionReplacementMode(SubscriptionReplacementMode.DEFERRED)
                ProrationMode.IMMEDIATE_WITH_TIME_PRORATION -> params.setSubscriptionReplacementMode(SubscriptionReplacementMode.WITH_TIME_PRORATION)
                ProrationMode.IMMEDIATE_AND_CHARGE_FULL_PRICE -> params.setSubscriptionReplacementMode(SubscriptionReplacementMode.CHARGE_FULL_PRICE)
                else -> params.setSubscriptionReplacementMode(SubscriptionReplacementMode.UNKNOWN_REPLACEMENT_MODE)
            }
